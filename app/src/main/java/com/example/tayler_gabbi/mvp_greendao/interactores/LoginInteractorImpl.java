...
public class LoginInteractorImpl implements LoginInteractor {
    ...
    @Override
    public void validarUser(String user, String password, UsuarioDao usuarioDao) {
        if(TextUtils.isEmpty(user) || TextUtils.isEmpty(password)){

            loginPresenter.validarUsuario();
            ...
            if(listaUsuario!= null && listaUsuario.size() > 0) {
                ...
                loginPresenter.usuarioSucces(user,password,usuarioDao);

            } else {

                loginPresenter.usuarioError();
            }
        }
    }
}
